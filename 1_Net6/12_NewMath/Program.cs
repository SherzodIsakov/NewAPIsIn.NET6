...
//Новые перезагрузки методов:
//Min, Max, Abs, Sign, Clamp - поддержкой nint и nuint
//DivRem - возвращают кортежи

//Новые методы:SinCos, ReciprocalEstimate, ReciprocalSqrtEstimate
