// .NET 6 имеет реализацию спецификации API метрик OpenTelemetry.
// Класс Meter создает объекты инструментов.

// Есть классы инструментов: Counter, Histogram, ObservableCounter, ObservableGauge
